...
const Main = () => {
    return(
        <div className="flex flex-col min-h-screen justify-items-start p-7 md:p-0">
            <h1 className=" flex flex-col p-4 bg-zinc-700 rounded-xl mb-5 md:mb-0 text-center mt-10">Hello, I'm an indie app developer based in México.</h1>
                <section className="flex flex-col md:flex-row md:justify-between md:items-center">
                    <div className=" flex flex-col">
                        ...
                        <div className="flex flex-col items-center md:mb-5">
                            <div className=" flex flex-col border-white border-2 rounded-full items-center justify-center mt-5 ">
                            ...
                            <h1 className="underline-offset-4 underline font-semibold mb-2">Work</h1>
